...
// update property
router.put("/properties/:id", auth(Role.LANDLORD, Role.ADMIN), propertyController.updateProperty);
// update Rental requests
router.put("/requests/:id", auth(Role.LANDLORD, Role.ADMIN), propertyController.updateRentalRequestStatus);
// get landlord rental requests
router.get("/landlord/requests", auth(Role.LANDLORD), propertyController.getLandlordRentalRequests);
// delete property
router.delete("/properties/:id", auth(Role.LANDLORD, Role.ADMIN), propertyController.deleteProperty);
