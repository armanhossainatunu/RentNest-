...
const initializePayment = async (property, user, transactionId) => {
    ...
    const response = await axios.post("https://sandbox.sslcommerz.com/gwprocess/v4/api.php", form.toString(), {
        headers: {
